...
export async function POST(request: Request) {
  ...
  try {
    ...
    const uploadsPdfDir = path.join(process.cwd(), "public/Uploads/FileDownload");
    ...
    const relativeFilePath = `/Uploads/FileDownload/${pdfUUID}`;

    const query = `
      INSERT INTO formdowsloads (Title, TypeForm, TypeMember, FilePath, CreateDate)
      VALUES (?, ?, ?, ?, NOW())
    `;
