...
export async function GET() {
  ...
  try {
    ...
    const query = "SELECT Id, Name, Position, Priority, Type, Image FROM treeorganizational WHERE Type != 'คณะกรรมการดำเนินการ' AND Type !='ผู้ตรวจสอบบัญชีและผู้ตรวจสอบกิจการ' ORDER BY Id ASC";
