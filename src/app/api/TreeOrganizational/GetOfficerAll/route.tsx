...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const query = "SELECT Id, Name, Position, Priority, Type, ImagePath FROM treeorganizational WHERE Type != 'คณะกรรมการดำเนินการ' AND Type !='ผู้ตรวจสอบบัญชีและผู้ตรวจสอบกิจการ' ORDER BY Id ASC";
