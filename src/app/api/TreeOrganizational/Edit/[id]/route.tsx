...
export async function PUT(
  ...
  try {
    ...
    let query = "UPDATE treeorganizational SET Name = ?, Position = ?, Priority = ?, Type = ?, UpdateDate = NOW()";
    const paramsArray: (string | null)[] = [name, position, priority, type];
    ...
    if (imageFile) {
      ...
      query += ", ImagePath = ?";
      paramsArray.push(`/Uploads/TreeOrganizational/${imageUUID}`);
    }
