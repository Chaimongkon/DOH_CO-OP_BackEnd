...
export async function PUT(
  ...
  try {
    ...
    let query = "UPDATE services SET Title = ?, MainType = ?, Subcategories = ?, URLLink = ?, UpdateDate = NOW()";
    const paramsArray: (string | null)[] = [title, mainType, subcategories, urlLink];
    ...
    if (imageFile) {
      ...
      query += ", ImagePath = ?";
      paramsArray.push(`/Uploads/Services/${imageUUID}`);
    }
