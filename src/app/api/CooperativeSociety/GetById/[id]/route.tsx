...
export async function GET(
  ...
  try {
    ...
    const query =
      "SELECT ImagePath, SocietyType FROM cooperativesociety WHERE Id = ?"; // Use file paths instead of binary data
    ...
    const processedRows = rows.map((row) => {
      return {
        ...row,
        ImagePath: row.ImagePath, // Use the file path for the PDF
      };
    });
